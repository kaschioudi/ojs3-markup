...
<form id="markupSettingsForm" class="pkp_form" method="post" action="{url router=$smarty.const.ROUTE_PAGE op="settings" save=true}"  enctype="multipart/form-data" autocomplete="off">
	...
	{fbvFormSection list=true description="plugins.generic.markup.settings.conversionStages" description="plugins.generic.markup.settings.conversionStagesHelp"}
		...
		{fbvElement type="checkbox" name="xmlConversionStages[]" id="conversionReviewStage" value=$smarty.const.WORKFLOW_STAGE_ID_INTERNAL_REVIEW label="manager.publication.reviewStage" checked=$smarty.const.WORKFLOW_STAGE_ID_INTERNAL_REVIEW|@in_array:$xmlConversionStages}
	...
	{fbvFormSection list=true description="plugins.generic.markup.settings.editWithSubstanceStages" description="plugins.generic.markup.settings.editWithSubstanceStagesHelp"}
		...
		{fbvElement type="checkbox" name="editWithSubstanceStages[]" id="editWithSubstanceReviewStage" value=$smarty.const.WORKFLOW_STAGE_ID_INTERNAL_REVIEW label="manager.publication.reviewStage" checked=$smarty.const.WORKFLOW_STAGE_ID_INTERNAL_REVIEW|@in_array:$editWithSubstanceStages}
